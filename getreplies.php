...
$getRepliesQuery = "SELECT r.replyId, r.reply, r.postId, r.date, u.userId, u.username FROM reply r LEFT JOIN user u ON r.userId = u.userId WHERE r.postId = '$_postId' ORDER BY r.replyId ASC";
